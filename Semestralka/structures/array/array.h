...
namespace structures 
{
	...
	Array<T>::Array(const Array<T>& other) :
		vector_(new Vector(*(other.vector_))), //musi tam byt * lebo chcem kopiu toho konkretneho vektora a nie smernika na vektor
		size_(other.size_)
	{
	}
	...
	{
		//TODO 02: Array
		// Allow when size of both arrays are same!!!!
		if (this != &other) {
			if (size_ != other.size_) {
				throw std::invalid_argument("Arrays size difer!");
			}
			*vector_ = *(other.vector_); // bez smernikov by nastal memory leak!! - pamat v povodnom vector_ by niekde ostala alokovana a nic by na nu neukazovalo!
		}
		return *this;
	}
	...
	{
		//TODO 02: Array
//		throw std::runtime_error("Array<T>::operator[]: Not implemented yet.");
	...
	{
		//TODO 02: Array
		// Staci porovnavat ich vectory tych poli lebo velkost je osetrovana uz vo vektore!
	...
	inline int Array<T>::mapFunction(const int index) const
	{
		...
		// vynasobim zadany index velkostou prvku, aby som dostal ten konkretny prvok ktory chcem!
