...
//		else
//			throw logic_error("Prototype for type_ " + ui::UIRoutines::convertStructureADSToStr(ads) + " is already registered!");
//	}
//
...
//		}
//		else
//			throw logic_error("Can not create structure of type_ " + ui::UIRoutines::convertStructureADSToStr(ads) + "!");
//	}
//
